...
typedef ::testing::Types<
    Params<thrust::device_vector<int>, std::decay_t<decltype(thrust::hip::par)>>,//_det)>>,
    Params<thrust::device_vector<float>, std::decay_t<decltype(thrust::hip::par)>>,//_det)>>,
    Params<thrust::device_vector<double>, std::decay_t<decltype(thrust::hip::par)>>>//,_det)>>,
    // Params<thrust::device_vector<int>, std::decay_t<decltype(thrust::hip::par__det_nosync)>>,
    // Params<thrust::device_vector<float>, std::decay_t<decltype(thrust::hip::par__det_nosync)>>,
    // Params<thrust::device_vector<double>, std::decay_t<decltype(thrust::hip::par__det_nosync)>>>
